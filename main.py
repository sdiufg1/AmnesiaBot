...
async def scrim(ctx):
    if ctx.channel.id == 889549859911258185:
        ...
        await ctx.send("https://cdn.discordapp.com/attachments/901446933460172820/906512633237237870/image0-1.gif")
    ...
    if ctx.channel.id != 889549859911258185:
        await ctx.send("tu est dans le mauvais channel pour taper cette commande.")
